...
// (DO NOT EDIT: machine generated header) 'FMX.SE.Logger.pas' rev: 34.00 (Windows)

#ifndef Fmx_Se_LoggerHPP
#define Fmx_Se_LoggerHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FMX_SE_LOGGER)
using namespace Fmx::Se::Logger;
#endif
