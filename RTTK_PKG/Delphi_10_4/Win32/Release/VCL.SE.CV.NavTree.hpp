...
private:
	...
	void __fastcall LoadRepoItems(const System::DynamicArray<Vcl::Se::Supporttypes::TSESupportRepoCompRef*> ARepoItems, Vcl::Tmsfnctreeviewdata::TTMSFNCTreeViewNode* const AParentNode);
