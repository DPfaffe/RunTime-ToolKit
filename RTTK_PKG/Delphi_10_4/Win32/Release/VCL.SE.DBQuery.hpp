...
// (DO NOT EDIT: machine generated header) 'VCL.SE.DBQuery.pas' rev: 34.00 (Windows)

#ifndef Vcl_Se_DbqueryHPP
#define Vcl_Se_DbqueryHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_SE_DBQUERY)
using namespace Vcl::Se::Dbquery;
#endif
