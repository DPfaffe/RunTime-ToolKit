...
// (DO NOT EDIT: machine generated header) 'VCL.SE.SupportTypes.pas' rev: 34.00 (Windows)

#ifndef Vcl_Se_SupporttypesHPP
#define Vcl_Se_SupporttypesHPP
...
private:
	...
	System::DynamicArray<TSESRepoLabel*> __fastcall GetLabels();
	int __fastcall GetItemCount();
	System::DynamicArray<TSESupportRepoCompRef*> __fastcall GetItems();
	
public:
	__property System::UnicodeString Text1 = {read=GetText1};
	__property System::UnicodeString Text2 = {read=GetText2};
	__property System::DynamicArray<TSESRepoLabel*> Labels = {read=GetLabels};
	...
	__property System::DynamicArray<TSESupportRepoCompRef*> Items = {read=GetItems};
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_SE_SUPPORTTYPES)
using namespace Vcl::Se::Supporttypes;
#endif
