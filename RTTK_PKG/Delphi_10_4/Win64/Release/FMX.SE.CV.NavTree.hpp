...
private:
	...
	void __fastcall LoadRepoItems(const System::TArray__1<Fmx::Se::Supporttypes::TSESupportRepoCompRef*> ARepoItems, Fmx::Tmsfnctreeviewdata::TTMSFNCTreeViewNode* const AParentNode);
