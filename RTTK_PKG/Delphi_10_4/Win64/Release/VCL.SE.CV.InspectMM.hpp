...
// (DO NOT EDIT: machine generated header) 'VCL.SE.CV.InspectMM.pas' rev: 34.00 (Windows)

#ifndef Vcl_Se_Cv_InspectmmHPP
#define Vcl_Se_Cv_InspectmmHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_VCL_SE_CV_INSPECTMM)
using namespace Vcl::Se::Cv::Inspectmm;
#endif
