...
public:
	...
	void __fastcall AddScreenShot(const System::UnicodeString AScreenName, Fmx::Tmsfnctypes::TTMSFNCBitmap* const ABitmap, const bool ASysGenerated = true, const System::UnicodeString AMsg = System::UnicodeString());
